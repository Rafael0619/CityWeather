...
const Error404 = () =>{
    return ( 
        <div className="display_flex error_width " >
        <div className="-content-center row col-12 container_Error">
        <div className="col-12 Warning-error justify-content-center">
            ...
            <Link to="/">
                <button className="btn_backtoHome col-12">Back To Home</button>
            </Link>
        </div>
    </div>
    </div>
